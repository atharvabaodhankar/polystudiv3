...
const Home = ({ navLogoRef }) => {
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <section id="hero" className="h-[90vh] min-h-[500px] bg-cover bg-center relative flex items-center justify-start overflow-hidden" style={{ backgroundImage: `url('/home.png')` }}>
